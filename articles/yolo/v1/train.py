...
from articles.functions import map
...
def main():
    ...
    test_dataset = VOCDataset(
        "/Users/armandbryan/Downloads/archive/test.csv", transform=transform, img_dir=IMG_DIR, label_dir=LABEL_DIR,
    )
